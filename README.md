...
|----------|--------------|-------------|
| **AWS Managed Cloud CI/CD Pipeline** | Full CI/CD automation using Bitbucket, AWS S3, SNS, CodeBuild, and CodeArtifact(Switch to ci-aws Branch) | [🔗 View Repo](https://github.com/Saliu40/currentJob-vprofile-project.git) |
