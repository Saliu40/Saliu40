...
|----------|--------------|-------------|
| **AWS Managed Cloud CI/CD Pipeline(Switch to ci-aws Branch)** | Full CI/CD automation using Bitbucket, AWS S3, SNS, CodeBuild, and CodeArtifact | [🔗 View Repo](https://github.com/Saliu40/currentJob-vprofile-project.git) |
